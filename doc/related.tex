...
To the best of our knowledge, the methodology presented in this paper is
the first to propose using cloud computing resources to lower the autotuning 
costs using the OpenTuner framework.
