...
\begin{abstract}
    ...
    Although the autotuner is able to find incrementally better solutions 
    quickly, finding good configurations typically takes a very long time. 
    This sequential search takes even longer to find optimizations
    for programs with considerable execution times.

    This paper proposes a methodology and a communication protocol for the 
    distributed execution of autotuners implemented in the OpenTuner framework.
    It presents an extension to the OpenTuner measurement driver that
    ...
    framework using an application benchmark. We offer insight into the problem
